...
import static ro.andrei.bootstarter.support.Constants.DEFAULT_SERIES_LENGTH;
import static ro.andrei.bootstarter.support.Constants.DEFAULT_TOKEN_LENGTH;
import static ro.andrei.bootstarter.support.Constants.TOKEN_VALIDITY_DAYS;
import static ro.andrei.bootstarter.support.Constants.TOKEN_VALIDITY_SECONDS;
...
public class CustomPersistentRememberMeServices extends AbstractRememberMeServices {
	...
	@Inject
	public CustomPersistentRememberMeServices(AppProperties appProperties, UserDetailsService userDetailsService) {
